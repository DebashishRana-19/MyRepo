...
<tr><th>Product Bar-Code Number</th><th>Product Name</th><th>Product Description</th><th>Price</th><th>Product Image</th><th>Product Status</th></tr>
...
<%}else{%>
<td><a href="paproove.jsp?pname=<%=rs.getString(3)%>">Approve</a>&nbsp;&nbsp;&nbsp;&nbsp;
<a href="preject.jsp?pname=<%=rs.getString(3)%>">Reject</a></td>
</tr><%}}%>
</table></center>
<br><br>
<%

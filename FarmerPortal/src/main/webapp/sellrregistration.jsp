...
<center><h1><font color="#ff33cc" size="6">Seller Registration</font></h1><center><br>
	...
	<tr>
	   ...
	   <tr>
		<td><font size="4" color="black">Email:</font></td>
		...
		<tr>
		<td><font size="4" color="black">Name of the Organization</font></td>
		<td><input type="text" name="org"required></td>
		</tr>
		<tr>
		<td><font size="4" color="black">Address</font></td>
		<td><input type="text" name="address"required></td>
		</tr>
		<tr>
		<td><font size="4" color="black">Business Permit Number</font></td>

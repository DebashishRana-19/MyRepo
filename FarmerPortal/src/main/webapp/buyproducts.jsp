...
<tr><th>Product Bar-Code Number</th><th>Product Name</th><th>Product Description</th><th>Price</th><th>Product Image</th><th>Rating</th></tr>
<style>
...
ResultSet rs= st1.executeQuery("select * from products where status='approved' ");
...
%><br>
<a href="viewrat.jsp?id=<%=rs.getString(1)%>" target="_blnak">View Reviews</a>
...
<td><a href='addwish.jsp?pnumber=<%=rs.getString(1)%>'>WishList</a></td>
<td><a href='' onclick="return popitup('raiting.jsp?pnumber=<%=rs.getString(1)%>')">Rating</a></td><%}%></tr>

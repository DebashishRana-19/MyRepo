...
try{
	...
	int tItems=0;
		...
		ResultSet rs1 = st1.executeQuery("SELECT SUM(total) FROM orderdetails where  status='wait'");
		if(rs1.next())
	{
        ...
        ResultSet rs = st.executeQuery("select * from orderdetails where email='"+email+"' and status='wait'");
        while(rs.next())
        {
...
<td align="center"><img src="images/<%=rs.getString(3)%>" alt="home" height="70" width="70"></td>
<td align="center"><strong><font size="4" color="#000000"><%=rs.getString(2)%></font></strong></td>

<td align="center"><a href="deleteproduct.jsp?pname=<%=rs.getString(1)%>"><font size="4" color="#ff0000"><img src="images/delete.png" alt="home" height="30" width="30"></font></strong></td>
</tr>
<%}%>
</table>
<br>
...
<td>
<input type="button" value="Procees To Checkout" onclick="window.location.href='selectpaytype.jsp'">
</td>
